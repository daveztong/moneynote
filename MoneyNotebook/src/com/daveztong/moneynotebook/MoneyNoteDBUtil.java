...
public class MoneyNoteDBUtil {
     ...
     * @param rowId delete row according to this rowId,if rowId = -1,then delete all records
     */
    public void delete(long rowId) {
        if (rowId == -1) {
            db.delete(MoneyNote.TABLE_NAME_MoneyNote, "1", null);
            return;
        }
     ...
     * 
     */
    private class MoneyNoteDBHelper extends SQLiteOpenHelper {
